...
//Recibo los 3 datos del formulario
    ...
    $doc = $_POST['doc'];
    $forums = $_POST['forums'];
    $error_tracker = $_POST['error_tracker'];

    $sql = "INSERT INTO distro (name, ostype, based, origin, arch, desktop, category, status, description, image, main_page, version, doc, forums, error_tracker) VALUES (:name, :ostype, :based, :origin, :arch, :desktop, :category, :status, :descriptiom, :image, :main_page, :version, :doc, :forums, :error_tracker)";
...
<div class="container">
    ...
    <form action="add.php" method="post">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="InputName" placeholder="Distro Name" name="Name">
        </div>
        <div class="form-group">
